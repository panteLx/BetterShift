                ...
                return (
                  <>
                    ...
                    {maxShiftsToShow === undefined
                      ...
                      : regularShifts.slice(0, maxShiftsToShow).map((shift) => (
                          <div
                            key={shift.id}
                            className="text-[10px] sm:text-xs px-0.5 py-0.5 sm:px-1.5 sm:py-1 rounded"
                            style={{
                          ...
                          >
                            <div
                              className={`font-semibold leading-[1.1] sm:leading-tight ${
                                showFullTitles ? "" : "line-clamp-2"
                              }`}
                            >
                              {shift.title}
                    ...
                    {maxExternalShiftsToShow === undefined
                      ? externalNormalShifts.map((shift) => (
                          <div
                            key={shift.id}
                            className="text-[10px] sm:text-xs px-0.5 py-0.5 sm:px-1.5 sm:py-1 rounded"
                            style={{
                      ...
                      : externalNormalShifts
                          .slice(0, maxExternalShiftsToShow)
                          .map((shift) => (
                            <div
                              key={shift.id}
                              className="text-[10px] sm:text-xs px-0.5 py-0.5 sm:px-1.5 sm:py-1 rounded"
