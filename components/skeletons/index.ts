 ...
 * All skeletons are component-based for maximum flexibility
 */
export { AppFooterSkeleton } from "./footer-skeleton";
export { AuthHeaderSkeleton } from "./header-skeleton";
export { AuthContentSkeleton } from "./auth-content-skeleton";
